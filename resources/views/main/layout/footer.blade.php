    ...
    <div class="nk-copyright">
        <div class="container">
            <div class="nk-copyright-left">
                <a target="_blank" href="#">©2024 Kiếm võ. All Rights Reserved</a>
            </div>
...
{{--                    <li><a class="nk-social-steam" href="#"><span class="fab fa-steam"></span></a></li>--}}
                    <li><a class="nk-social-facebook" href="{{ config('app.link_fb_page') }}"><span class="fab fa-facebook"></span></a></li>
                    <li><a href="{{ config('app.link_zalo') }}">
