...
@section('index')
    ...
    <div class="nk-image-slider" data-autoplay="5000">
        <div class="nk-image-slider-item">
            <img src="{{asset('main/images/slide-1.jpg')}}" alt="" class="nk-image-slider-img" data-thumb="{{asset('main/images/slide-1-thumb.jpg')}}">
        ...
        <div class="nk-image-slider-item">
            <img src="{{asset('main/images/slide-2.jpg')}}" alt="" class="nk-image-slider-img" data-thumb="{{asset('main/images/slide-2-thumb.jpg')}}">
        ...
        <div class="nk-image-slider-item">
            <img src="{{asset('main/images/slide-3.jpg')}}" alt="" class="nk-image-slider-img" data-thumb="{{asset('main/images/slide-3-thumb.jpg')}}">

        </div>

        <div class="nk-image-slider-item">
            <img src="{{asset('main/images/slide-4.jpg')}}" alt="" class="nk-image-slider-img" data-thumb="{{asset('main/images/slide-4-thumb.jpg')}}">
        ...
        <div class="nk-image-slider-item">
            <img src="{{asset('main/images/slide-5.jpg')}}" alt="" class="nk-image-slider-img" data-thumb="{{asset('main/images/slide-5-thumb.jpg')}}">
            ...
            <aside class="nk-sidebar nk-sidebar-right nk-sidebar-sticky">
                ...
                <div class="nk-widget nk-widget-highlighted">
                    ...
                    <div class="nk-widget-content">
                        ...
                        <div class="nk-widget-post">
                            <a href="blog-article.html" class="nk-post-image">
                                <img src="{{asset('main/images/post-3-sm.jpg')}}" alt="">
                            </a>
