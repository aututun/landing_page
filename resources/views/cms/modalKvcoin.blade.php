                        ...
                        <div class="modal-body" style="align-items: center;">
                            <div class="row">
                                <div class="col mb-3">
                                    ...
                                    <input required type="text" id="LoginName" class="form-control" placeholder="Tên đăng nhập game của bạn" />
                                </div>
                            </div>
                            <div class="row g-2">
                                <div class="col mb-0">
                            ...
                            <div class="row">
                                <div class="col mb-3">
                                    ...
                                    <select required id="KVcoin" name="KVcoin" class="form-select color-dropdown">
                                        <option value="20">20.000 VNĐ - 20 KV coin</option>
                                        <option value="50">50.000 VNĐ - 50 KV coin</option>
                                        <option value="100">100.000 VNĐ - 100 KV coin</option>
                                        <option value="200">200.000 VNĐ - 200 KV coin</option>
                                        <option value="500">500.000 VNĐ - 500 KV coin</option>
                                        <option value="1000">1.000.000 VNĐ - 1000 KV coin</option>
                                        <option value="2000">2.000.000 VNĐ - 2000 KV coin</option>
                                        <option value="5000">5.000.000 VNĐ - 5000 KV coin</option>
                                    </select>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col mb-3">
                                    <label for="nameBasic" class="form-label">Lời nhắn (<small> tùy chọn </small>) </label>
                                    <input required type="text" id="LoginName" class="form-control" placeholder="Tên đăng nhập game của bạn" />
                                </div>
                            </div>
                        </div>
