...
{{--                </svg>--}}
                  <a href="{{asset('/')}}">
                      <img src="{{asset('main/images/logo.png')}}" height="50px" width="50px" class="img-fluid" alt="Responsive image">
                      <span class="app-brand-text demo menu-text fw-bolder ms-2">Trang chủ</span>
                  </a>
              </span>
        </a>
