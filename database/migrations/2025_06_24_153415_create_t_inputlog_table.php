...
class CreateTInputlogTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('mysql_game')->create('t_inputlog', function (Blueprint $table) {
    ...
    {
        Schema::connection('mysql_game')->dropIfExists('t_inputlog');
    }
