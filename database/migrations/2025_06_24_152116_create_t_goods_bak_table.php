...
class CreateTGoodsBakTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('mysql_game')->create('t_goods_bak', function (Blueprint $table) {
            $table->integer('Id');
    ...
    {
        Schema::connection('mysql_game')->dropIfExists('t_goods_bak');
    }
