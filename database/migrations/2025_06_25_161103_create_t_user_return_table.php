...
class CreateTUserReturnTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('mysql_game')->create('t_user_return', function (Blueprint $table) {
            $table->increments('id');
    ...
    public function down(): void {
        Schema::connection('mysql_game')->dropIfExists('t_user_return');
    }
